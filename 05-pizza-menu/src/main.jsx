  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        ...
        <p>We're are still working on our menu. Please come later :) </p>
      )}

      {/* We Can't use forEach instead of map because in JSX we only return new array and work on it That does the map() method */}
    </main>
  );
}

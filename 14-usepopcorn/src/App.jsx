...
export default function App() {
  ...
  // setWatched([]) To many rereneder

  // it did not return anything but instead we pass in a effect callback function
  // [] only run when the component mount , at will run when the component run at very first time.
  // Data Fetching
  // side effect , component interaction with outside the world.
  ...
  // if (isLoading) {
  //   return <div>Movies is Loading</div>;
  // }
